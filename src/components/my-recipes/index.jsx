...
const MyRecipes = () => {
  return (
    <div className="w-full bg-white px-4 sm:px-8 md:px-16 py-12 flex justify-center">
      <div className="max-w-[1600px] w-full">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 px-4">
          ...
          <button className="bg-[#BA49E7] text-lg sm:text-xl text-white font-semibold px-6 sm:px-12 py-3 sm:py-4 rounded-full">
            See All
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 px-4">
          {recipeData.map((item, index) => (
            ...
            >
              ...
              />
              <div className="bg-gray-100 flex items-center justify-between w-full px-8 py-3 mt-auto">
                <p className="text-sm gap-x-1 font-semibold text-gray-800 flex justify-center items-center">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 15 15"
              ...
              <div className="flex flex-col items-start justify-start text-left p-4">
                <p className="font-semibold text-3xl">{item.title}</p>
                <p className="underline text-[#9747FF]">View Recipe</p>
              </div>
            </div>
          ))}
        </div>
